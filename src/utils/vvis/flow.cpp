...
#include "vis.h"
#include "vmpi.h"
#include <windows.h>	// MODIFIED INCLUDES START HERE (note2self: cleanup obsolete includes)
#include <stdio.h>
#include <string.h>
#include <direct.h>
...
// Offload the function to a seperate file, I'm not touching the rest of flow.cpp lol   (at least not yet.)
